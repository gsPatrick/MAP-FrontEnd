...
const CartoesPage = () => {
  ...
  const userNameForHeader = currentProfile?.ownerClientName || "Usuário Cartões";
  ...
  if (loadingProfiles || (isAuthenticated && !currentProfile)) {
    return (
        <Layout style={{ minHeight: '100vh' }} className="cartoes-page-main-layout">
  ...
  if (!isAuthenticated) {
    return <Layout style={{ minHeight: '100vh', justifyContent: 'center', alignItems: 'center' }}><Title level={3}>Por favor, faça login para acessar esta página.</Title></Layout>;
  }
