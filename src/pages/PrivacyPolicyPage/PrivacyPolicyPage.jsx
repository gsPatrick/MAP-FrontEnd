...
const PrivacyPolicyPage = () => {
  return (
    <Layout className="privacy-policy-layout">
      <Header /> {/* Incluir o Header */}

      <Content className="privacy-policy-main-content">
        <div className="privacy-policy-section-container">
            {/* Envolver o conteúdo da política em um bloco com fundo claro */}
            <div className="privacy-policy-content-block">
              ...
              <ul>
                ...
                <li>**Dados de Negócio:** (Para contas PJ/MEI) Informações sobre seus clientes de negócio (nome, contato, notas), detalhes de produtos/estoque, informações sobre serviços oferecidos.</li>
