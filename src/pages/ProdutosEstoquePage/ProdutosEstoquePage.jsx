...
const ProdutosEstoquePage = () => {
  ...
  const userNameForHeader = "Gestor de Estoque";
  ...
  const productTableColumns = [
    ...
    // { title: 'Categoria', dataIndex: 'productCategory', key: 'productCategory', width: 150, responsive: ['lg'],
  ...
  if (loadingProfiles || (!isAuthenticated && !currentProfile)) {
     return (
        <Layout style={{ minHeight: '100vh' }} className="produtos-estoque-page-layout restricted-access-bg">
  ...
  return (
    <Layout style={{ minHeight: '100vh' }} className="produtos-estoque-page-layout">
      <SidebarPanel collapsed={sidebarCollapsed} onCollapse={setSidebarCollapsed} selectedProfileType={currentProfile?.type} />
      <Layout className="site-layout" style={{ marginLeft: sidebarCollapsed ? 80 : 220 }}>
        <HeaderPanel userName={userNameForHeader} />
        ...
        >
          <Form form={productForm} layout="vertical" onFinish={onProductFormFinish} className="product-modal-form">
            ...
            <Row gutter={20}>
              ...
              {/* Categoria Removida
              <Col xs={12} sm={8}><Form.Item name="productCategoryId" label="Categoria do Produto (ID)"><Input placeholder="ID da Categoria" /></Form.Item></Col> 
              */}
        ...
        <Modal
          ...
          width={700}
          className="stock-history-modal modal-style-map" // Reutiliza estilo base se aplicável
        >
          <Table
            columns={[
