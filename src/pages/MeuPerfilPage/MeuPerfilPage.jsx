...
import dayjs from 'dayjs'; // <<<<<<<<<< ADICIONAR ESTA LINHA
import 'dayjs/locale/pt-br'; // Opcional, mas bom para consistência se usar formatações localizadas
...
// Configurar locale do dayjs (se ainda não estiver globalmente em outro lugar)
dayjs.locale('pt-br'); // <<<< ADICIONAR ESTA LINHA SE NÃO ESTIVER GLOBAL
...
const MeuPerfilPage = () => {
    ...
    return (
        <Layout style={{ minHeight: '100vh' }}>
            ...
            <Layout className="site-layout" style={{ marginLeft: sidebarCollapsed ? 80 : 220 }}>
                <HeaderPanel userName={"Carregando..."} appName={sidebarCollapsed ? "" : "MAP"} />
  ...
  return (
    <Layout style={{ minHeight: '100vh' }} className="meu-perfil-page-layout">
      <SidebarPanel
